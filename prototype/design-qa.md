...
- Implementation captures: `qa/workspace-floating-card.png`, `qa/full-wrapped.png`, `qa/share-poster.png`, `qa/real-floating.png`, `qa/real-share.png`
...
- Complete view reveals every card selected by the real Composer (one to five, without filler), while keeping the strongest item first and its supporting evidence visible beside it.
...
- Complete result contains the exact real Composer card count and grounded evidence.
